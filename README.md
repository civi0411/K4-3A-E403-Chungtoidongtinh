...
**Lớp:** 3A · **Phòng:** E403 · **Cụm:** ____ · **Track:** A (VLearn Tutor)

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
| Trần Chí Vĩ | 2A202602968 | Đội trưởng (Team Lead) | Quản lý tiến độ chung, chủ trì viết `spec.md` (§1, §2, §4, §8), nộp các Checkpoint, phụ trách trình bày Demo CP6 |
| Nguyễn Nam Khánh | 2A202602568 | Thành viên (Data & Eval) | Phân tích data chatlog (`vlearn-pack`), thu thập số liệu evidence chuẩn B, xây dựng bộ Golden set ≥20 case và chạy đo lường (`eval/`) |
| Nguyễn Phi Nhật | 2A202602658 | Thành viên (Tech & Prototype) | Thiết kế system prompt cho AI Tutor, xây dựng flow tương tác và code prototype chạy thật có gọi LLM (`codebase/`) |
| Hoàng Minh Tuấn | 2A202602758 | Thành viên (Product & Testing) | Thiết kế kịch bản 4 lớp chỗ khó (§5), áp dụng nguyên tắc HAX/PAIR, điều phối thử nghiệm người dùng (R6 - `validation/`), làm slide trình bày (`demo-slides.pdf`) |
